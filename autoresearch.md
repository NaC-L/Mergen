...
## Current best
- metric: 412 vm-shaped samples (run #67, commit 4b764fd)
- why it won: 127 cumulative new samples across 67 logged runs in this segment. Eleven sibling-op pairs closed: satsub<>satadd, borrowchain<>carrychain, xormulsub<>xormuladd_chain, addxor<>subxor_chain, notor<>notand_chain, andxor_pair<>orxor_pair, pairmix_sub<>pairmix, threestate_xormul_sub<>threestate_xormul, lfsr64_galois<>lfsr64, zigzag_substep<>zigzag_step, lcg_ansi_chain_sub<>lcg_ansi_chain.
