...
## Current best
- metric: 413 vm-shaped samples (run #68, commit 71f71e7)
- why it won: 128 cumulative new samples across 68 logged runs in this segment. Twelve sibling-op pairs closed: satsub<>satadd, borrowchain<>carrychain, xormulsub<>xormuladd_chain, addxor<>subxor_chain, notor<>notand_chain, andxor_pair<>orxor_pair, pairmix_sub<>pairmix, threestate_xormul_sub<>threestate_xormul, lfsr64_galois<>lfsr64, zigzag_substep<>zigzag_step, lcg_ansi_chain_sub<>lcg_ansi_chain, xorrot_substep<>xorrot.
