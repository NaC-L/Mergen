...
**Diagnostics:**
- lifted IR missing: C:\Users\Yusuf\Desktop\mergenrewrite\rewrite-regression-work\ir_outputs\vm_sdiv64_loop.ll
...
|---|--------|----------|--------|--------|------------|-------|
| 1 | RCX=0 | 0 | 0 | — | **no** | x=0: 0 trips (val !> 0) |
| 2 | RCX=1 | 1 | 1 | — | **no** | x=1, div=3: 1/3=0 -> 1 trip |
| 3 | RCX=10 | 2 | 2 | — | **no** | x=10, div=4: 10->2->0 |
| 4 | RCX=100 | 3 | 3 | — | **no** | x=100, div=6: 100->16->2->0 |
| 5 | RCX=1000 | 10 | 10 | — | **no** | x=1000, div=2: log2(1000)+1 |
| 6 | RCX=51966 | 6 | 6 | — | **no** | x=0xCAFE, div=8 |
| 7 | RCX=3405691582 | 11 | 11 | — | **no** | x=0xCAFEBABE, div=8 |
| 8 | RCX=18446744073709551615 | 0 | 0 | — | **no** | max u64 -> -1 signed: 0 trips |
| 9 | RCX=9223372036854775807 | 20 | 20 | — | **no** | INT64_MAX, div=9 |
| 10 | RCX=1311768467463790320 | 61 | 61 | — | **no** | 0x123...DEF0, div=2 |

## Failure detail

### case 1: x=0: 0 trips (val !> 0)
...
### case 5: x=1000, div=2: log2(1000)+1
...
### case 7: x=0xCAFEBABE, div=8

- inputs: `RCX=3405691582`
- manifest expected: `11`
- native: `11`
- lifted: `—`

### case 8: max u64 -> -1 signed: 0 trips
...
### case 10: 0x123...DEF0, div=2

- inputs: `RCX=1311768467463790320`
- manifest expected: `61`
- native: `61`
- lifted: `—`
