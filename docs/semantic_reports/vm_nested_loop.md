# vm_nested_loop - semantic equivalence
...
|---|--------|----------|--------|--------|-------|
| 1 | RCX=0 | 0 | 0 | pass | a=0,b=0: no iterations |
| 2 | RCX=1 | 0 | 0 | pass | a=1,b=0: inner never runs |
| 3 | RCX=2 | 0 | 0 | pass | a=2,b=0: inner never runs |
| 4 | RCX=4 | 0 | 0 | pass | a=0,b=1: outer never runs |
| 5 | RCX=5 | 0 | 0 | pass | a=1,b=1: one cell, 0+0 |
| 6 | RCX=7 | 3 | 3 | pass | a=3,b=1: 0+1+2 |
| 7 | RCX=10 | 4 | 4 | pass | a=2,b=2: (0+1)+(1+2)=4 |
| 8 | RCX=11 | 9 | 9 | pass | a=3,b=2: 1+3+5=9 |
| 9 | RCX=15 | 18 | 18 | pass | a=3,b=3: 3+6+9=18 |
| 10 | RCX=255 | 18 | 18 | pass | high bits ignored: a=3,b=3 |
