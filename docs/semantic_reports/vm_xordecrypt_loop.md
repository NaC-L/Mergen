# vm_xordecrypt_loop - semantic equivalence
...
|---|--------|----------|--------|--------|-------|
| 1 | RCX=0 | 1112 | 1112 | pass | key=0: sum of (buf[i] ^ i) |
| 2 | RCX=1 | 1096 | 1096 | pass | key=1 |
| 3 | RCX=51 | 1064 | 1064 | pass | key=0x33 |
| 4 | RCX=85 | 936 | 936 | pass | key=0x55 |
| 5 | RCX=119 | 920 | 920 | pass | key=0x77 |
| 6 | RCX=127 | 856 | 856 | pass | key=0x7F |
| 7 | RCX=170 | 1112 | 1112 | pass | key=0xAA |
| 8 | RCX=192 | 984 | 984 | pass | key=0xC0 |
| 9 | RCX=255 | 1112 | 1112 | pass | key=0xFF |
| 10 | RCX=256 | 1112 | 1112 | pass | key=0 again (mask drops bit 8) |
