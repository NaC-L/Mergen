# bytecode_vm_loop - semantic equivalence
...
| 2 | RCX=1 | 0 | 0 | pass | odd bytecode loop limit 1 returns 0 |
| 3 | RCX=3 | 3 | 3 | pass | odd bytecode loop: 0+1+2 |
| 4 | RCX=5 | 10 | 10 | pass | odd bytecode loop: 0+1+2+3+4 |
| 5 | RCX=7 | 21 | 21 | pass | odd bytecode loop: 0..6 |
