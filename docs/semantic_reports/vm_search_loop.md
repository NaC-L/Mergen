# vm_search_loop - semantic equivalence
...
- **IR size:** 125 lines, 1 function definitions

## Semantic cases

| # | Inputs | Expected | Actual | Result | Label |
|---|--------|----------|--------|--------|-------|
| 1 | RCX=0 | 8 | 8 | pass | target=1: not in table |
| 2 | RCX=2 | 0 | 0 | pass | target=3: index 0 |
| 3 | RCX=6 | 1 | 1 | pass | target=7: index 1 |
| 4 | RCX=10 | 2 | 2 | pass | target=11: index 2 |
| 5 | RCX=12 | 3 | 3 | pass | target=13: index 3 |
| 6 | RCX=22 | 1 | 1 | pass | target=7 again after mask: index 1 |
| 7 | RCX=28 | 3 | 3 | pass | target=13 again after mask: index 3 |
| 8 | RCX=4 | 8 | 8 | pass | target=5: not in table |
| 9 | RCX=15 | 8 | 8 | pass | target=16: not in table |
| 10 | RCX=16 | 8 | 8 | pass | target=1 again (mask drops bit 4) |
