# vm_lfsr_loop - semantic equivalence
...
|---|--------|----------|--------|--------|-------|
| 1 | RCX=0 | 1 | 1 | pass | n=0: state=seed=1 |
| 2 | RCX=1 | 1 | 1 | pass | n=0, seed forced to 1 |
| 3 | RCX=256 | 184 | 184 | pass | n=1, seed=1: 1 -> 0xB8 |
| 4 | RCX=257 | 184 | 184 | pass | n=1, seed=1 again |
| 5 | RCX=128 | 129 | 129 | pass | n=0, seed=0x81 |
| 6 | RCX=129 | 129 | 129 | pass | n=0, seed=0x81 (lsb forced) |
| 7 | RCX=512 | 92 | 92 | pass | n=2, seed=1: 1 -> 0xB8 -> 0x5C |
| 8 | RCX=1280 | 179 | 179 | pass | n=5, seed=1 |
| 9 | RCX=4095 | 117 | 117 | pass | n=15, seed=0xFF |
| 10 | RCX=4660 | 81 | 81 | pass | n=2, seed=0x35 |
