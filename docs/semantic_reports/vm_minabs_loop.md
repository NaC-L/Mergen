# vm_minabs_loop - semantic equivalence
...
|---|--------|----------|--------|--------|-------|
| 1 | RCX=0 | 128 | 128 | pass | limit=1, target=-128 |
| 2 | RCX=1 | 128 | 128 | pass | limit=2, target=-128 |
| 3 | RCX=8 | 128 | 128 | pass | limit=9, target=-128 |
| 4 | RCX=16 | 127 | 127 | pass | 0x10: limit=1, target=-127 |
| 5 | RCX=128 | 120 | 120 | pass | 0x80: limit=1, target=-120 |
| 6 | RCX=255 | 113 | 113 | pass | 0xFF: limit=16, target=-113 |
| 7 | RCX=2748 | 4 | 4 | pass | 0xABC: limit=13, target=43 |
| 8 | RCX=3295 | 1 | 1 | pass | 0xCDF: limit=16, target=77 |
| 9 | RCX=4660 | 93 | 93 | pass | 0x1234: limit=5, target=-93 |
| 10 | RCX=65535 | 3 | 3 | pass | 0xFFFF: limit=16, target=127 |
| 11 | RCX=2063 | 0 | 0 | pass | 0x80F: limit=16, target=0; perfect i=0 |
